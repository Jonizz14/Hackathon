...
export default function Chat() {
  ...
  const sendMessage = async () => {
    ...
    setMessages((prev) => [
      ...prev,
      { id: aiMessageId, sender: "ai", text: "Thinking..." },
    ]);
    ...
    try {
        ...
        contents: [
          {
            ...
            parts: [
              {
                text: `Your name is Stim.AI and you were created by the WhileTrue() team and your goal is to help users on this ZooMarketPro website and give them advice only related to animals and the animal world, and you answer briefly and clearly`,
              },
            ],
          },
      ...
      if (
        ...
        botText =
          "The answer you asked about was previously disliked. Please post another question.";
      }
      ...
      >
        {!open && (
          <button className="chat__toggle-btn" onClick={toggleChatOpen}>
            <div className="chat__icon-wrapper">🦴</div>
          </button>
        )}
        ...
        {open && (
          <>
            <div className="chat__header">
              <h1 style={{ color: "#8b4513" }} className="ai-title">
                STIM AI
              </h1>
            ...
            <div className="chat__input">
              ...
              />
              <button style={{background: '#10b981'}} onClick={sendMessage} disabled={loading}>
                Yuborish
              </button>
            </div>
          </>
